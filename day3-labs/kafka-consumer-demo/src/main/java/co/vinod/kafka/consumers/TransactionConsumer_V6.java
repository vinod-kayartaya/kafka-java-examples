...
public class TransactionConsumer_V6{
...
System.out.println("Consumer V6 started...");
while(true){
...
if(r.value().contains("60000")) throw new RuntimeException("Simulated failure"); c.commitSync();
}
}
}
}